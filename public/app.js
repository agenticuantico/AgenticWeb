...
document.querySelectorAll(".nav-item").forEach(b=>b.onclick=()=>b.dataset.view==="chat"?showChat():panel(b.dataset.view));document.querySelectorAll("[data-view]").forEach(b=>{if(!b.classList.contains("nav-item"))b.onclick=()=>panel(b.dataset.view)});
